...
if [ $? -eq 0 ]
then
wget -qO- translate.yandex.ru/tr.json/translate --post-data="srv=tr-text&lang=$sLNG-$tLNG&text=$text" | sed 's/"//g' | zenity --width=600 --height=240 --title "Translation for $text" --text-info
